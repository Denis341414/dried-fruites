...
<template>
  ...
  <div class="aboutUs_cont">
    <h1 class="main_title">О доставке</h1>
    <div class="subtext">Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. 
      ...
      но и перешагнул в электронный дизайн. Lorem Ipsum - это текст-"рыба", 
    ...
    <div class="logo"><img class="logo_img" src="../About_us/assets/Темный 1.svg" alt=""></div>
  </div>
  <Main_footer/>
  <Footer/>
</template>
