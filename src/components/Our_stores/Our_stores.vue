...
<template>
  ...
  <div class="aboutUs_cont">
    <h1 class="main_title">Магазины</h1>
    <div class="sub_items">
      <div class="item1">
        <img src="" alt="" class="item_img">
        <div class="item_subtext">Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. 
          ...
          но и перешагнул в электронный дизайн.</div>
      </div>
      <div class="item2">
        <img src="" alt="" class="item_img">
        <div class="item_subtext">Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. 
